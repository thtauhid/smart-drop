...
export function FileUpload() {
  ...
  const handleUpload = async () => {
    ...
    setTimeout(() => {
      ...
      setShareLink(`https://smartdrop.example/share/${Math.random().toString(36).substring(2, 15)}`)
    }, 2500)
  }
  ...
  return (
    <div className="space-y-6">
      {!file && !uploadComplete ? (
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center gap-4">
            ...
            <p className="text-xs text-amber-600 mt-2">Maximum file size: 100MB</p>
          </div>
        </div>
      ) : (
          ...
          {!uploadComplete ? (
            <>
              ...
              <div className="space-y-4">
                <Progress value={progress} className="h-2 bg-amber-200" indicatorClassName="bg-amber-600" />
                <div className="flex justify-between">
                  <p className="text-sm text-amber-700">{uploading ? "Uploading..." : "Ready to upload"}</p>
            ...
            <div className="space-y-6">
              ...
              <div className="p-4 bg-amber-200 rounded-lg">
                <p className="text-sm font-medium mb-2">Share this link (expires in 24 hours):</p>
      ...
      <div className="bg-amber-200 border-2 border-amber-600 rounded-lg p-4 text-sm">
        ...
        <p>Files are automatically deleted after 24 hours. No registration required.</p>
      </div>
    </div>
  )
}
